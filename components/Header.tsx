    ...
    <header className="sticky top-0 z-20 border-b border-tq-100 bg-white/90 backdrop-blur">
      <div className="mx-auto flex h-14 w-full max-w-2xl items-center justify-between px-4">
        <Link href="/" className="flex items-center gap-2">
          <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-tq-600 text-sm font-bold text-white">
            MT
          </span>
        ...
        <div
          className="flex gap-0.5 rounded-full border border-tq-200 p-0.5"
          role="group"
